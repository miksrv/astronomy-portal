...
const StargazingHowToPage: NextPage<object> = () => {
    ...
    const title = t('pages.stargazing-howto.title', 'Как проходят астровыезды')
    ...
    return (
        <AppLayout
            ...
            title={title}
            description={t(
                'pages.stargazing-howto.description',
        ...
        >
            ...
            <Container style={{ marginBottom: '10px' }}>
                ...
                <h3 style={{ marginTop: 10 }}>
                    {t('pages.stargazing-howto.registration', 'Регистрация на астровыезд')}
                </h3>
                <p style={{ margin: 0 }}>
                    {t(
                        'pages.stargazing-howto.registration_text',
                ...
                <h3 style={{ marginTop: 10 }}>{t('pages.stargazing-howto.location', 'Место проведения')}</h3>
                <p style={{ marginTop: 0 }}>
                    {t(
                        'pages.stargazing-howto.location_text',
            ...
            <Container style={{ marginBottom: '10px' }}>
                ...
                <ul style={{ listStyle: 'decimal', marginBottom: 0 }}>
                    ...
                    <li style={{ marginBottom: '10px' }}>
                        <h3>{t('pages.stargazing-howto.lecture', 'Астролекция')}</h3>
                        <p style={{ margin: 0 }}>
                            {t(
                                'pages.stargazing-howto.lecture_text',
                    ...
                    <li style={{ marginBottom: '10px' }}>
                        <h3>{t('pages.stargazing-howto.orientation', 'Ориентация по звездному небу')}</h3>
                        <p style={{ margin: 0 }}>
                            {t(
                                'pages.stargazing-howto.orientation_text',
                                'После лекции мы учим вас находить основные звезды и созвездия, показывая их на небе. Эта часть длится около 20 минут.'
                            )}
                        </p>
                    </li>
                    <li>
                        <h3>{t('pages.stargazing-howto.telescope_observation', 'Наблюдение в телескопы')}</h3>
                        <p style={{ margin: 0 }}>
                            {t(
                                'pages.stargazing-howto.telescope_observation_text',
            ...
            <Container style={{ marginBottom: '10px' }}>
                ...
                <p style={{ margin: 0 }}>
                    {t(
                        'pages.stargazing-howto.recommendations_text',
                ...
                <h3 style={{ marginTop: 10 }}>
                    {t('pages.stargazing-howto.thematic_evenings', 'Тематические вечера')}
                </h3>
                <p style={{ marginTop: 0 }}>
                    {t(
                        'pages.stargazing-howto.thematic_evenings_text',
                ...
                <p style={{ margin: 0 }}>
                    {t('pages.stargazing-howto.faq', 'Не нашли ответа на свой вопрос? Загляните в раздел')}
                    <Link
                        href={'/stargazing/faq'}
                    ...
                    {t('pages.stargazing-howto.telegram', 'или пишите в нашем Telegram-канале')}
                    <Link
