...
const StargazingFAQPage: NextPage<object> = () => {
    ...
    const faqItems: FaqItem[] = [
        ...
        {
            question: t('pages.stargazing-faq.questions.registration.question', '❓Можно ли приехать без регистрации?'),
            answer: t(
        ...
        {
            question: t('pages.stargazing-faq.questions.support.question', '❓Вы мне нравитесь! Как вас поддержать?'),
            answer: (
                <>
