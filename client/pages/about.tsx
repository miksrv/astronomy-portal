    ...
    return (
        <AppLayout
            ...
            description={t(
                ...
                'Узнайте больше о проекте «Смотри на звёзды», нашей команде и самодельной астрономической обсерватории. Присоединяйтесь к нам и откройте для себя красоту космоса!'
            )}
            openGraph={{
                images: [
                    {
