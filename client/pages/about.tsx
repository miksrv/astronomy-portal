    ...
    <main>
        ...
        <div className={'box'}>
            ...
            <p>
                ...
                самодельной астрономической обсерватории, работающей в удаленном
                режиме. Это уникальный проект в Оренбургской области. Наша
                обсерватория работает автономно и позволяет получать снимки
                объектов дальнего космоса. Наша цель - сделать астрономию
                доступной абсолютно для всех. Поэтому наша обсерватория является
                открытой для всех желающих - каждый может воспользоваться ей для
                получения изображений космоса. В ближайшее время на базе этого
                сайта мы запустим <strong>бесплатный</strong> сервис управления
                телескопом.
            </p>
            <Gallery
            ...
            <h2>👨‍🚀 Наша команда</h2>
            <p>
                Мы работаем в самых разных сферах, но всех нас объединяет одно -
                любовь к космосу. С 2016 года мы вместе смотрим на звезды,
                популяризируем астрономию и развиваем наши проекты.
            </p>
            <Team />
            <h2>🌌 Астрономический проект &quot;Смотри на звезды&quot;</h2>
            <p>
                В 2016 году в Оренбургской области мы запустили
                научно-популярный проект под названием «Смотри на звезды». С тех
                пор каждый сезон наша команда устраивает бесплатные
                астрономические лекции под открытым небом. Мы выезжаем за город
                с телескопами, проводим астролекторий и организуем вечера
                тротуарной астрономии. Целью проекта является создание доступной
                астрономии для всех желающих. Мы делаем космос ближе!
            </p>
            <p>
                Наш проект «Смотри на звезды» с первых дней привлек внимание
                широкой аудитории. Мы стремимся разбудить интерес к космосу у
                детей, подростков и взрослых, показывая им его величие и
                загадочность. Главная идея заключается в том, чтобы каждый
                человек смог насладиться ночным небом и проникнуться чудесами
                Вселенной с помощью наших вечеров астрономии и астровыездов.
            </p>
            <Gallery
            ...
            <p>
                ...
                выездные экскурсии в удаленные места, где нет сильного светового
                загрязнения, что позволяет наблюдать звезды во всей их красе.
                Наша команда астрономов, волонтеров и научных работников всегда
                готова поделиться своими знаниями и опытом, чтобы каждый
                желающий мог лучше понять и полюбить астрономию.
            </p>
            <p>
                Одной из ключевых составляющих проекта являются лекции, которые
                проводят опытные астрономы-любители. Мы рассказываем о научных
                открытиях, об истории астрономии и ее современных достижениях.
                Лекции не только позволяют расширить знания слушателей, но и
                вдохновляют на дальнейшее изучение этой удивительной науки. Все
                лекции проводим в простом формате. Рассказываем аудитории
                сложные вещи простым языком.
            </p>
            <p>
                Особое внимание мы уделяем вечерам тротуарной астрономии. Это
                неформальные встречи, которые проводятся под открытым небом в
                самых доступных местах города.
            </p>
            <h2>✅ Ваша помощь</h2>
            <p>
            ...
            <p>
                ...
                развитию этого проекта. А наша обсерватория всегда нуждается в
                вашей поддержке.
            </p>
